...
export class Iteration {
 ...
 removeUnsupportedCandidates(){if(this.data.settings.riskMode!=='standard')return;for(const review of this.data.reviews||[])review.candidates=(review.candidates||[]).filter(candidate=>!Array.isArray(candidate.settlementTypes)||candidate.settlementTypes.length!==1||candidate.settlementTypes[0]==='real');}
