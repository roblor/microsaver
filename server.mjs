...
export function createServer(app,port=8765){
 ...
 if(req.url==='/api/orders/reconcile'){return json(200,await app.reconcileOrders());}
 if(req.url==='/api/orders/remove-rejected'){return json(200,await app.removeRejectedOrders());}
 ...
 const paths={'/':'index.html','/app.js':'app.js','/navigation.js':'navigation.js','/positions.js':'positions.js','/journal.js':'journal.js','/style.css':'style.css','/modern.css':'modern.css','/navigation.css':'navigation.css','/positions.css':'positions.css','/journal.css':'journal.css'};
